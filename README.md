...
Begin by running `npm install`. This will install the dependencies needed for testing purpose.

### Compiling the binary

You can compile either by using the `make compile` command. Or manually write this command

```bash
$ gcc commands.c fileHandling.c main.c -o todo
```
